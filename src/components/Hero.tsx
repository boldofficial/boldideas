...
const Hero: React.FC = () => {
	return (
		<section
			id="home"
			className="relative pt-32 pb-24  lg:pt-48  lg:pb-40  px-4 lg:px-24 bg-brand-light overflow-hidden">
			<div className="absolute top-0 left-0 w-1/2 h-full bg-brand-navy/2 -skew-x-12 transform -translate-x-1/4 pointer-events-none" />
			<div className="absolute top-40 right-10 w-96 h-96 bg-brand-gold/10 rounded-full blur-[120px] pointer-events-none" />
			...
			<div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
				<div className="text-left animate-fade-in">
					<div className="inline-flex items-center space-x-2 bg-white border border-brand-navy/5 rounded-full px-4 py-1.5 mb-8 shadow-sm">
						...
						<span className="text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-brand-navy/60">
							AI Digital Marketing & Automation Agency
						</span>
					</div>

					<h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-brand-navy leading-[1.05] tracking-tighter mb-8">
						Automate. <br />
						<span className="text-brand-gold italic">Innovate.</span>
						<br />
						Thrive.
					</h1>

					<p className="text-lg text-slate-600 max-w-xl mb-12 leading-relaxed font-light">
						Bold Ideas Innovation is an AI digital marketing & automation agency
						that helps ambitious teams work smarter and grow faster. We blend AI
						consulting, workflow automation, and AI-powered digital marketing—to
						turn big goals into measurable results.
					</p>
						...
						<div className="absolute inset-0 flex items-center justify-center">
							<div className="relative w-[85%] h-[85%] glass-card rounded-[4rem] border border-white p-12 shadow-2xl flex items-center justify-center group overflow-hidden bg-white/60">
								<div
									...
									style={{
										backgroundImage:
											'radial-gradient(#002D5B 1px, transparent 1px)',
								...
								<svg
									...
									<path
										d="M100,20 C65,20 40,45 40,80 C40,110 60,135 75,145 L75,165 C75,170 80,175 85,175 L115,175 C120,175 125,170 125,165 L125,145 C140,135 160,110 160,80 C160,45 135,20 100,20 Z"
										fill="none"
										stroke="#002D5B"
										strokeWidth="4"
