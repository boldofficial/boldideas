             ...
             <div className="space-y-8">
                <div className="flex items-start space-x-6 group">
                   ...
                   <div>
                      ...
                      <p className="text-slate-500 font-mono text-sm">hello@boldideasinnovation.com</p>
                   </div>
                </div>
             ...
             <div className="bg-white border border-brand-navy/10 p-1 rounded-sm shadow-2xl relative">
                ...
                <div className="p-8">
                   <form className="space-y-6">
                      ...
                      <button className="w-full bg-brand-navy text-white px-8 py-5 rounded-sm font-black hover:bg-brand-gold hover:text-brand-navy transition-all shadow-lg uppercase tracking-widest text-xs border border-transparent hover:border-brand-navy relative group overflow-hidden">
